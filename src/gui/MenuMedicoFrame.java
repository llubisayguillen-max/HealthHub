...
public class MenuMedicoFrame extends JFrame {
    ...
    private void initUI() {
        ...
        JLabel lblNombre = new JLabel(
                "Dra. " + capitalizarNombre(medico.getNombreCompleto()) +
        ...
        JPanel cardDisp = crearCard(
                "Gestión de agenda",
                "/gui/img/DispoMed.png",
                "Definí tus horarios de atención",
                "Controlá tus días y horarios disponibles",
                "Disponibilidad",
                () -> new DispoMedicoFrame(medico).setVisible(true)
        );

        // Card 2: Agenda y turnos (ver/gestionar turnos)
        JPanel cardAgenda = crearCard(
                "Agenda y turnos",
                "/gui/img/AgendaMed.png",
                "Consultá tus turnos por fecha y estado",
                "Visualizá y gestioná tus turnos",
                "Abrir agenda",
                () -> new AgendaMedicoFrame(medico).setVisible(true)
        );

        // Centramos dos tarjetas
    ...
    private JPanel crearCard(String titulo,
        ...
        Dimension cardSize = new Dimension(320, 230); // un poquito más anchas para que 2 llenen mejor
